...
const Error = () => {
  ...
  const errorMessage =
    errorProps?.statusMessage || "Server Error or Page not found";
  ...
  return (
    <div className="error_container">
      ...
      <NavLink to="/" className="error_homebutton">
        Go to Homepage
      </NavLink>
      <button className="error_details" onClick={handleShowErrorDetails}>
        Show Details
      </button>
      {errorDetails && (
        <>
